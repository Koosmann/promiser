...
function Agreement($scope, $compile) {
	...
	$scope.$watch('agreementData', function () {
		switch ($scope.agreementData.type) {
			case 'payment':
				var agreementTemplate = "<div>I, <span class='p-key-item'>{{ agreementData.initiatorFirstName }}</span> <span class='p-key-item'>{{ agreementData.initiatorLastName }}</span> <span class='p-key-item-group'>(<span class='p-key-item-light'>{{ agreementData.initiatorEmail }}</span></span>, owe <span class='p-key-item'>{{ agreementData.amount }}</span> to <span class='p-key-item'>{{ agreementData.recipientFirstName }}</span> <span class='p-key-item'>{{ agreementData.recipientLastName }}</span> <span class='p-key-item-group'>(<span class='p-key-item-light'>{{ agreementData.recipientEmail }}</span>)</span> and promise to pay them within <span class='p-key-item'>{{ agreementData.dueDaysFromNow }}</span> {{ agreementData.dueDaysFromNow|pluralizeDays }}.</div>"
				break;
			case 'product':
				var agreementTemplate = "<div>I, <span class='p-key-item'>{{ agreementData.initiatorFirstName }}</span> <span class='p-key-item'>{{ agreementData.initiatorLastName }}</span> <span class='p-key-item-group'>(<span class='p-key-item-light'>{{ agreementData.initiatorEmail }}</span>)</span>, am borrowing <span class='p-key-item'>{{ agreementData.item }}</span> from <span class='p-key-item'>{{ agreementData.recipientFirstName }}</span> <span class='p-key-item'>{{ agreementData.recipientLastName }}</span> <span class='p-key-item-group'>(<span class='p-key-item-light'>{{ agreementData.recipientEmail }}</span>)</span> and promise to return it to them within <span class='p-key-item'>{{ agreementData.dueDaysFromNow }}</span> {{ agreementData.dueDaysFromNow|pluralizeDays }}.</div>"
				break;
			case 'service':
				var agreementTemplate = "<div>I, <span class='p-key-item'>{{ agreementData.initiatorFirstName }}</span> <span class='p-key-item'>{{ agreementData.initiatorLastName }}</span> <span class='p-key-item-group'>(<span class='p-key-item-light'>{{ agreementData.initiatorEmail }}</span>)</span>, am agreeing to <span class='p-key-item'>{{ agreementData.service }}</span> for <span class='p-key-item'>{{ agreementData.recipientFirstName }}</span> <span class='p-key-item'>{{ agreementData.recipientLastName }}</span> <span class='p-key-item-group'>(<span class='p-key-item-light'>{{ agreementData.recipientEmail }}</span>)</span> and promise to do so within <span class='p-key-item'>{{ agreementData.dueDaysFromNow }}</span> {{ agreementData.dueDaysFromNow|pluralizeDays }}.</div>"
				break;
		}
